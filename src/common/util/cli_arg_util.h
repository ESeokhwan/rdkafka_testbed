...
constexpr OptionWrapper KAFKA_BROKER_OPTION = {"kafka-broker", required_argument, nullptr, static_cast<int>(LongOnlyOptionVals::KAFKA_BROKER), "Kafka broker address"};

constexpr OptionWrapper MQTT_BROKER_OPTION = {"mqtt-broker", required_argument, nullptr, static_cast<int>(LongOnlyOptionVals::MQTT_BROKER), "MQTT broker address"};
...
constexpr OptionWrapper MSG_SIZE_OPTION = {"msg-size", required_argument, nullptr, 'm', "Message size in bytes"};

constexpr OptionWrapper RUNNING_TIME_OPTION = {"running-time", required_argument, nullptr, 'r', "Running time (seconds)"};

constexpr OptionWrapper OUTDIR_OPTION = {"outdir", required_argument, nullptr, 'o', "Output directory"};
constexpr OptionWrapper OUT_PREFIX_OPTION = {"out-prefix", required_argument, nullptr, static_cast<int>(LongOnlyOptionVals::OUT_PREFIX), "Prefix for output files"};


constexpr OptionWrapper CLIENT_CNT_OPTION = {"client-cnt", required_argument, nullptr, static_cast<int>(LongOnlyOptionVals::CLIENT_CNT), "Number of clients"};
constexpr OptionWrapper SERVICE_CNT_OPTION = {"service-cnt", required_argument, nullptr, static_cast<int>(LongOnlyOptionVals::SERVICE_CNT), "Number of services"};
constexpr OptionWrapper TOPIC_CNT_PER_CLIENT_OPTION = {"topic-cnt-per-client", required_argument, nullptr, static_cast<int>(LongOnlyOptionVals::TOPIC_CNT_PER_CLIENT), "Number of topics per client"};

constexpr OptionWrapper START_IDX_OPTION = {"start-idx", required_argument, nullptr, static_cast<int>(LongOnlyOptionVals::START_IDX), "Start index"};

constexpr OptionWrapper NOISE_STDDEV_OPTION = {"noise-stddev", required_argument, nullptr, static_cast<int>(LongOnlyOptionVals::NOISE_STDDEV), "Noise standard deviation"};
constexpr OptionWrapper INTERVAL_NOISE_STDDEV_OPTION = {"interval-noise-stddev", required_argument, nullptr, static_cast<int>(LongOnlyOptionVals::INTERVAL_NOISE_STDDEV), "Interval noise standard deviation"};
...
constexpr OptionWrapper FOR_CREATION_OPTION = {"for-creation", no_argument, nullptr, static_cast<int>(LongOnlyOptionVals::FOR_CREATION), "Enable creation mode"};
constexpr OptionWrapper NEED_FLUSH_OPTION = {"need-flush", no_argument, nullptr, static_cast<int>(LongOnlyOptionVals::NEED_FLUSH), "Enable flush after producing messages"};
constexpr OptionWrapper IGNORE_RESPONSE_OPTION = {"ignore-response", no_argument, nullptr, static_cast<int>(LongOnlyOptionVals::IGNORE_RESPONSE), "Ignore response"};
constexpr OptionWrapper IS_SYNC_OPTION = {"is-sync", no_argument, nullptr, static_cast<int>(LongOnlyOptionVals::IS_SYNC), "Enable synchronous mode"};
...
constexpr OptionWrapper NO_LOG_OPTION = {"no-log", no_argument, nullptr, static_cast<int>(LongOnlyOptionVals::NO_LOG), "Disable monitoring log"};
constexpr OptionWrapper TAG_RECORD_OPTION = {"tag-record", no_argument, nullptr, static_cast<int>(LongOnlyOptionVals::TAG_RECORD), "Enable record tagging"};
constexpr OptionWrapper READ_TAGGED_ONLY_OPTION = {"read-tagged-only", no_argument, nullptr, static_cast<int>(LongOnlyOptionVals::READ_TAGGED_ONLY), "Read tagged records only"};
constexpr OptionWrapper SAMPLE_LOG_OPTION = {"sample-log", no_argument, nullptr, static_cast<int>(LongOnlyOptionVals::SAMPLE_LOG), "Enable log sampling"};

constexpr OptionWrapper WARMUP_CNT_OPTION = {"warmup-cnt", required_argument, nullptr, static_cast<int>(LongOnlyOptionVals::WARMUP_CNT), "Number of messages for warmup"};
constexpr OptionWrapper WARMUP_TOPIC_OPTION = {"warmup-topic", required_argument, nullptr, static_cast<int>(LongOnlyOptionVals::WARMUP_TOPIC), "Warmup topic"};
...
constexpr OptionWrapper SHARE_PRODUCER_OPTION = {"share-producer", no_argument, nullptr, static_cast<int>(LongOnlyOptionVals::SHARE_PRODUCER), "Enable sharing producer"};
